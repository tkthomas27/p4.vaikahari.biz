	<div class='title'>
		...
		<div class="landing-nouser">
			<fieldset>
				<legend><h1>Uh-oh Something went wrong...</h1></legend>
			<p class='intro'>
			Looks like there was a problem! Maybe you tried signing up with someone else's email... Try re-signing in, or, if you are already a member, try logging in again
			</p>
			<br>
